...
export function ClientHomePage({
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Tab Content */}
      <div className="mt-8">
        {activeTab === 'overview' && <DashboardOverview initialStats={initialStats} />}
        {activeTab === 'profiles' && <UserProfileManager initialUsers={initialUsers} />}
        {activeTab === 'preferences' && <UserPreferencesManager initialUsers={initialUsers} initialPreferences={initialPreferences} />}
        {activeTab === 'posts' && <UserPostsManager initialPosts={initialPosts} />}
      </div>
    </div>
  )
}